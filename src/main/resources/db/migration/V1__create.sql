...
create table restaurant_has_schedule
(
    restaurant_id bigint not null,
...
create table restaurant_rated_by_customer
(
    restaurant_id bigint       not null,
...
(
    ...
    constraint menu_item_menu_item_category_fk foreign key (id) references menu_item_category (title)
);
